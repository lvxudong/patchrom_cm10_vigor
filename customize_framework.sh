...
then
    ...
    mv "$BUILD_OUT/framework/smali/android/widget" "$BUILD_OUT"
...
then
	...
	mv "$BUILD_OUT/widget" "$BUILD_OUT/framework2/smali/android"
	rm -rf "$BUILD_OUT/framework2/smali/com/google/android/mms"
        mkdir -p "$BUILD_OUT/framework2/smali/com/google/android"
